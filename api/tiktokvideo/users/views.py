    ...
    def get(self, request):
        ...
        if request.query_params.get('q'):
            ...
            for i in lis:
                ...
                """
                data['total_video'].insert(0, {'date': i['date'], 'num': i['total_video'], 'name': '总拍摄视频数'})
                data['done_video'].insert(0, {'date': i['date'], 'num': i['done_video'], 'name': '已完成视频数'})
                data['pending_video'].insert(0, {'date': i['date'], 'num': i['pending_video'], 'name': '待交付视频数'})
